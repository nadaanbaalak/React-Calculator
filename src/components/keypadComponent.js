...
class KeypadComponent extends Component {
    ...
    render() {
        return (
            <div className="keys">
                <button name="CE" onClick={event => this.props.onPress(event.target.name)}>CE</button>
                <button name="(" onClick={event => this.props.onPress(event.target.name)}>(</button>
                <button name=")" onClick={event => this.props.onPress(event.target.name)}>)</button>
                <button name="C" onClick={event => this.props.onPress(event.target.name)}>C</button>
                <br/>
                ...
                <button name="*" onClick={event => this.props.onPress(event.target.name)}>x</button>
                <br/>
